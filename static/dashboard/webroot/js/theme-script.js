...
const basePath = pathParts.join('/') + '/img/theme/';
                            ...
                            <div class="row gx-3">
                                    ...
                                    <div class="theme-layout mb-3">
                                        ...
                                        <label for="defaultLayout">
                                            <span class="d-block mb-2 layout-img">
                                                <img src="${basePath}default.svg" alt="img">
                                            </span>                                     
                                ...
                                <div class="col-4">
                                    <div class="theme-layout mb-3">
                                        ...
                                        <label for="miniLayout">
                                            <span class="d-block mb-2 layout-img">
                                                <img src="${basePath}mini.svg" alt="img">
                                            </span>                                    
                                ...
                                <div class="col-4">
                                    <div class="theme-layout mb-3">
                                        ...
                                        <label for="boxLayout">
                                            <span class="d-block mb-2 layout-img">
                                                <img src="${basePath}box.svg" alt="img">
                                            </span>                                    
                                ...
                                <div class="col-4">
                                    <a href="layout_rtl" class="theme-layout mb-3">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="${basePath}rtl.svg" alt="img">
                                        </span>                                    
